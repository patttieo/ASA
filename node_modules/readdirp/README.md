# readdirp [![Build Status](https://secure.travis-ci.org/thlorenz/readdirp.png)](//travis-ci.org/thlorenz/readdirp)

[![NPM](https://nodei.co/npm/readdirp.png?downloads=true&stars=true)](https://nodei.co/npm/readdirp/)

Recursive version of [fs.readdir](//nodejs.org/docs/latest/api/fs.html#fs_fs_readdir_path_callback). Exposes a **stream api**.
...
Meant to be one of the recursive versions of [fs](//nodejs.org/docs/latest/api/fs.html) functions, e.g., like [mkdirp](https://github.com/substack/node-mkdirp).

**Table of Contents**  *generated with [DocToc](//doctoc.herokuapp.com/)*
...
- to learn more about streams, consult the very detailed 
  [nodejs streams documentation](//nodejs.org/api/stream.html) or the
...
- **stat**          :  built in [stat object](//nodejs.org/docs/v0.4.9/api/fs.html#fs.Stats)
