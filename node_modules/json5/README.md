...
[ex1]: //plovr.com/docs.html
[ex2]: //npmjs.org/doc/json.html
[ex3]: //code.google.com/p/fuzztester/wiki/JSONFileFormat
...
- Object keys can be unquoted if they're valid [identifiers][mdn_variables].
  ...
  [[§11.1.5](//es5.github.com/#x11.1.5), [§7.6](//es5.github.com/#x7.6)].
...
- Strings can be split across multiple lines; just prefix each newline with a
  backslash. [ES5 [§7.8.4](//es5.github.com/#x7.8.4)]
...
Join the [Google Group](//groups.google.com/group/json5) if you're
...
[Michael Bolin](//bolinfest.com/) independently arrived at and published
some of these same ideas with awesome explanations and detail.
Recommended reading:
[Suggested Improvements to JSON](//bolinfest.com/essays/json.html)

[Douglas Crockford](//www.crockford.com/) of course designed and built
JSON, but his state machine diagrams on the [JSON website](//json.org/),
