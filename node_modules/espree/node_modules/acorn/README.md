...
files in `dist` using [Browserify](//browserify.org) and
[Babel](//babeljs.io/). If you are already using Babel, you can
...
### Existing plugins
 ...
 - [`acorn-objj`](https://www.npmjs.com/package/acorn-objj): [Objective-J](//www.cappuccino-project.org/learn/objective-j.html) language parser built as Acorn plugin
