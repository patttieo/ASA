...
[![browser support](//ci.testling.com/substack/browser-pack.png)](//ci.testling.com/substack/browser-pack)

[![build status](https://secure.travis-ci.org/substack/browser-pack.png)](//travis-ci.org/substack/browser-pack)
