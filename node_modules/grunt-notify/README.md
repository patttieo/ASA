## grunt-notify  [![Build Status](//img.shields.io/travis/dylang/grunt-notify.svg)](https://travis-ci.org/dylang/grunt-notify) [![grunt-notify](//img.shields.io/npm/dm/grunt-notify.svg)](https://www.npmjs.org/package/grunt-notify)
...
Install **growlnotify** from the [Growl Downloads Page](//growl.info/downloads). This will install in `/usr/local/bin/growlnotify`.
...
If you have downloaded and installed Snarl from [Snarl's web site](//snarl.fullphat.net/) you'll have the commandline tool heysnarl as well.

##### Growl for Windows

*Requires growlnotify for Windows.*

Install **growlnotify** from the [growlnotify Page](//www.growlforwindows.com/gfw/help/growlnotify.aspx).
...
[notify-send man page](//manpages.ubuntu.com/manpages/gutsy/man1/notify-send.1.html).
...
Here is a fix: //askubuntu.com/questions/128474/how-to-customize-on-screen-notifications
...
to the open source community. I'm also a tech lead at [Opower](//opower.com). [![@dylang](https://img.shields.io/badge/github-dylang-green.svg)](https://github.com/dylang) [![@dylang](https://img.shields.io/badge/twitter-dylang-blue.svg)](https://twitter.com/dylang)
...
Screenshots are [CC BY-SA](//creativecommons.org/licenses/by-sa/4.0/) (Attribution-ShareAlike).
