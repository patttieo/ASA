...
See [ESLint documentation](//eslint.org/docs/user-guide/configuring#extending-configuration-files) for more information about extending configuration files.
...
**Note**: This configuration will also enable JSX in [parser options](//eslint.org/docs/user-guide/configuring#specifying-parser-options).

# License

ESLint-plugin-React is licensed under the [MIT License](//www.opensource.org/licenses/mit-license.php).
