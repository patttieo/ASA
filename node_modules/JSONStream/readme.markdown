...
request({url: '//isaacs.couchone.com/registry/_all_docs'})
...
The `..` operator is the recursive descent operator from [JSONPath](//goessner.net/articles/JsonPath/), which will match a child at any depth (see examples below).
