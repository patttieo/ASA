...
Like duplexer (//npm.im/duplexer) but using streams2.

Overview
--------

duplexer2 is a reimplementation of [duplexer](//npm.im/duplexer) using the
...
* GitHub ([deoxxa](//github.com/deoxxa))
* Twitter ([@deoxxa](//twitter.com/deoxxa))
