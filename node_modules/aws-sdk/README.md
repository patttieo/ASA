# AWS SDK for JavaScript [![Version](https://badge.fury.io/js/aws-sdk.png)](//badge.fury.io/js/aws-sdk) [![Build Status](https://travis-ci.org/aws/aws-sdk-js.png?branch=master)](https://travis-ci.org/aws/aws-sdk-js)
