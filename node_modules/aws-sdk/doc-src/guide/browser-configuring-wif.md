...
as [Login with Amazon](//login.amazon.com/),
...
[IAM documentation](//docs.aws.amazon.com/IAM/latest/UserGuide/PoliciesOverview.html).
...
<p class="note">
  This example code must be run from a // or https:// host scheme.
