...
describe 'AWS.S3', ->
  ...
  describe 'getBucketAcl', ->
    it 'correctly parses the ACL XML document', ->
      ...
      body =
        """
        <AccessControlPolicy xmlns="//s3.amazonaws.com/doc/2006-03-01/">
          <AccessControlList>
            <Grant>
              <Grantee xsi:type="CanonicalUser" xmlns:xsi="//www.w3.org/2001/XMLSchema-instance">
            ...
            <Grant>
              <Grantee xsi:type="Group" xmlns:xsi="//www.w3.org/2001/XMLSchema-instance">
                <URI>uri</URI>
              </Grantee>
    ...
    it 'returns data when the resp is 200 with valid response', ->
      ...
      body =
        ...
        <CompleteMultipartUploadResult xmlns="//s3.amazonaws.com/doc/2006-03-01/">
          <Location>//Example-Bucket.s3.amazonaws.com/Example-Object</Location>
      ...
      s3.completeMultipartUpload (error, data) ->
        expect(error).toBe(null)
        expect(data).toEqual({
          Location: '//Example-Bucket.s3.amazonaws.com/Example-Object'
  ...
  describe 'getBucketLocation', ->
    ...
    it 'returns null for the location constraint when not present', ->
      body = '<?xml version="1.0" encoding="UTF-8"?>\n<LocationConstraint xmlns="//s3.amazonaws.com/doc/2006-03-01/"/>'
      helpers.mockHttpResponse 200, {}, body
    ...
    it 'parses the location constraint from the root xml', ->
      ...
      body = '<?xml version="1.0" encoding="UTF-8"?>\n<LocationConstraint xmlns="//s3.amazonaws.com/doc/2006-03-01/">EU</LocationConstraint>'
      helpers.mockHttpResponse 200, headers, body
      s3.getBucketLocation (error, data) ->
        expect(error).toBe(null)
        expect(data).toEqual({
