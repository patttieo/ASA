...
describe 'AWS.XML.Parser', ->
  ...
  describe 'default behavior', ->
    ...
    it 'ignores xmlns on the root element', ->
      xml = '<xml xmlns="//foo.bar.com"><Abc>xyz</Abc></xml>'
      parse xml, rules, (data) ->
              ...
              members:
                ...
                Attr2:
                  ...
                  members:
                    Foo: {}
      xml = """
      <xml xmlns="//s3.amazonaws.com/doc/2006-03-01/">
        <List>
          <member>
            <Attr1 xmlns:xsi="//www.w3.org/2001/XMLSchema-instance" xsi:type="CanonicalUser">abc</Attr1>
            <Attr2 xmlns:xsi="//www.w3.org/2001/XMLSchema-instance" xsi:type="CanonicalUser"><Foo>bar</Foo></Attr2>
          </member>
        </List>
      </xml>
      """
