...
The [modern build](https://github.com/lodash/lodash/wiki/Build-Differences) of [lodash](https://lodash.com/) exported as [Node.js](//nodejs.org/)/[io.js](https://iojs.org/) modules.
 ...
 * Follows [semantic versioning](//semver.org/) for releases
 * [Lazily evaluated](//filimanjaro.com/blog/2014/introducing-lazy-evaluation/) chaining
 ...
 * [_.curry](https://lodash.com/docs#curry) & [_.curryRight](https://lodash.com/docs#curryRight) for creating [curried](//hughfdjackson.com/javascript/why-curry-helps/) functions
 ...
 * [_.template](https://lodash.com/docs#template) supports [*“imports”*](https://lodash.com/docs#templateSettings-imports) options & [ES template delimiters](//people.mozilla.org/~jorendorff/es6-draft.html#sec-template-literal-lexical-components)
