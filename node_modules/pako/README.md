...
- Results are binary equal to well known [zlib](//www.zlib.net/) (now v1.2.8 ported).
...
- [browserify](//browserify.org/) (via [browserify-zlib](https://github.com/devongovett/browserify-zlib))
...
Full docs - //nodeca.github.io/pako/
...
- Vyacheslav Egorov ([@mraleph](https://github.com/mraleph)) for his awesome
  tutorials about optimising JS code for v8, [IRHydra](//mrale.ph/irhydra/)
