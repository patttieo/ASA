...
- Have [good commit messages](//tbaggery.com/2008/04/19/a-note-about-git-commit-messages.html)
- Have tests
...
The `grunt dev` implements watching for tests and allows for in browser testing at `//localhost:9999/spec/`.

If you notice any problems, please report them to the GitHub issue tracker at
[//github.com/wycats/handlebars.js/issues](//github.com/wycats/handlebars.js/issues).
...
[jsfiddle]: //jsfiddle.net/9D88g/46/
