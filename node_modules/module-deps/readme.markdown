...
[![build status](https://secure.travis-ci.org/substack/module-deps.png)](//travis-ci.org/substack/module-deps)
...
compile a language like [coffeescript](//coffeescript.org/) on the fly or
...
With [npm](//npmjs.org), to get the module do:
