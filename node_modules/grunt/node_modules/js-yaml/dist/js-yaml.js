...
function writeScalar(state, object, level, iskey) {
  ...
  // //www.yaml.org/spec/1.2/spec.html#ns-plain-first%28c%29
  if (CHAR_MINUS         === first ||
      CHAR_QUESTION      === first ||
  ...
  // //ecma262-5.com/ELS5_HTML.htm#Section_8.5
...
// YAML error class. //stackoverflow.com/questions/8458984
//
'use strict';
...
function composeNode(state, parentIndent, nodeContext, allowToSeek, allowCompact) {
  ...
  if (indentStatus === 1 || CONTEXT_BLOCK_OUT === nodeContext) {
    ...
    if (indentStatus === 1) {
      ...
      // //www.yaml.org/spec/1.2/spec.html#id2799784
...
// //www.yaml.org/spec/1.2/spec.html#id2804923
//
...
// extra types described at YAML tag repository. (//yaml.org/type/)
...
// //www.yaml.org/spec/1.2/spec.html#id2803231
//
// NOTE: JS-YAML does not support schema-specific tag resolution restrictions.
