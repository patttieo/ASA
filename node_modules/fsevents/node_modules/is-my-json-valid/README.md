...
A [JSONSchema](//json-schema.org/) validator that uses code generation
...
[![build status](//img.shields.io/travis/mafintosh/is-my-json-valid.svg?style=flat)](//travis-ci.org/mafintosh/is-my-json-valid)
...
* [cosmicreals.com benchmark](//cosmicrealms.com/blog/2014/08/29/benchmark-of-node-dot-js-json-validation-modules-part-3/)
