...
describe('Client', function () {
    ...
    describe('header()', function () {
        ...
        it('returns a valid authorization header (sha1)', function (done) {
            ...
            var header = Hawk.client.header('//example.net/somewhere/over/the/rainbow', 'POST', { credentials: credentials, ext: 'Bazinga!', timestamp: 1353809207, nonce: 'Ygvqdz', payload: 'something to write about' }).field;
