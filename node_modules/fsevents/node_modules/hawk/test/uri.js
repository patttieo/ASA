...
describe('Uri', function () {
    ...
    it('should generate a bewit then successfully authenticate it', function (done) {
        ...
        credentialsFunc('123456', function (err, credentials1) {
            ...
            var bewit = Hawk.uri.getBewit('//example.com/resource/4?a=1&b=2', { credentials: credentials1, ttlSec: 60 * 60 * 24 * 365 * 100, ext: 'some-app-data' });
            req.url += '&bewit=' + bewit;
    ...
    it('should generate a bewit then successfully authenticate it (no ext)', function (done) {
        ...
        credentialsFunc('123456', function (err, credentials1) {
            ...
            var bewit = Hawk.uri.getBewit('//example.com/resource/4?a=1&b=2', { credentials: credentials1, ttlSec: 60 * 60 * 24 * 365 * 100 });
            req.url += '&bewit=' + bewit;
