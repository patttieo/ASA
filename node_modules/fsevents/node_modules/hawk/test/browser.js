...
describe('Browser', function () {
    ...
    it('should generate a bewit then successfully authenticate it', function (done) {
        ...
        credentialsFunc('123456', function (err, credentials1) {
            ...
            var bewit = Browser.client.bewit('//example.com/resource/4?a=1&b=2', { credentials: credentials1, ttlSec: 60 * 60 * 24 * 365 * 100, ext: 'some-app-data' });
            req.url += '&bewit=' + bewit;
    ...
    it('should generate a bewit then successfully authenticate it (no ext)', function (done) {
        ...
        credentialsFunc('123456', function (err, credentials1) {
            ...
            var bewit = Browser.client.bewit('//example.com/resource/4?a=1&b=2', { credentials: credentials1, ttlSec: 60 * 60 * 24 * 365 * 100 });
            req.url += '&bewit=' + bewit;
    ...
    describe('bewit()', function () {
        ...
        it('returns a valid bewit value (explicit HTTP port)', function (done) {
            ...
            var bewit = Browser.client.bewit('//example.com:8080/somewhere/over/the/rainbow', { credentials: credentials, ttlSec: 300, localtimeOffsetMsec: 1356420407232 - Hawk.utils.now(), ext: 'xandyandz' });
    ...
    it('generates a header then successfully parse it (configuration)', function (done) {
        ...
        credentialsFunc('123456', function (err, credentials1) {
            ...
            req.authorization = Browser.client.header('//example.com:8080/resource/4?filter=a', req.method, { credentials: credentials1, ext: 'some-app-data' }).field;
    ...
    it('generates a header then successfully parse it (node request)', function (done) {
        ...
        credentialsFunc('123456', function (err, credentials1) {
            ...
            var reqHeader = Browser.client.header('//example.com:8080/resource/4?filter=a', req.method, { credentials: credentials1, ext: 'some-app-data', payload: payload, contentType: req.headers['content-type'] });
    ...
    it('generates a header then successfully parse it (time offset)', function (done) {
        ...
        credentialsFunc('123456', function (err, credentials1) {
            ...
            req.authorization = Browser.client.header('//example.com:8080/resource/4?filter=a', req.method, { credentials: credentials1, ext: 'some-app-data', localtimeOffsetMsec: 100000 }).field;
            expect(req.authorization).to.exist();
    ...
    it('generates a header with stale ts and successfully authenticate on second call', function (done) {
        ...
        credentialsFunc('123456', function (err, credentials1) {
            ...
            var header = Browser.client.header('//example.com:8080/resource/4?filter=a', req.method, { credentials: credentials1, ext: 'some-app-data' });
            ...
            Hawk.server.authenticate(req, credentialsFunc, {}, function (err, credentials2, artifacts2) {
                ...
                req.authorization = Browser.client.header('//example.com:8080/resource/4?filter=a', req.method, { credentials: credentials2, ext: 'some-app-data' }).field;
                expect(req.authorization).to.exist();
    ...
    it('generates a header then successfully parse it (with hash)', function (done) {
        ...
        credentialsFunc('123456', function (err, credentials1) {
            ...
            req.authorization = Browser.client.header('//example.com:8080/resource/4?filter=a', req.method, { credentials: credentials1, payload: 'hola!', ext: 'some-app-data' }).field;
            Hawk.server.authenticate(req, credentialsFunc, {}, function (err, credentials2, artifacts) {
    ...
    it('generates a header then successfully parse it (app)', function (done) {
        ...
        credentialsFunc('123456', function (err, credentials1) {
            ...
            req.authorization = Browser.client.header('//example.com:8080/resource/4?filter=a', req.method, { credentials: credentials1, ext: 'some-app-data', app: 'asd23ased' }).field;
            Hawk.server.authenticate(req, credentialsFunc, {}, function (err, credentials2, artifacts) {
    ...
    it('generates a header then successfully parse it (app, dlg)', function (done) {
        ...
        credentialsFunc('123456', function (err, credentials1) {
            ...
            req.authorization = Browser.client.header('//example.com:8080/resource/4?filter=a', req.method, { credentials: credentials1, ext: 'some-app-data', app: 'asd23ased', dlg: '23434szr3q4d' }).field;
            Hawk.server.authenticate(req, credentialsFunc, {}, function (err, credentials2, artifacts) {
    ...
    describe('client', function () {
        ...
        describe('header()', function () {
            ...
            it('returns a valid authorization header (sha1)', function (done) {
                ...
                var header = Browser.client.header('//example.net/somewhere/over/the/rainbow', 'POST', { credentials: credentials, ext: 'Bazinga!', timestamp: 1353809207, nonce: 'Ygvqdz', payload: 'something to write about' }).field;
            ...
            it('returns a valid authorization header (empty payload)', function (done) {
                ...
                var header = Browser.client.header('//example.net/somewhere/over/the/rainbow', 'POST', { credentials: credentials, ext: 'Bazinga!', timestamp: 1353809207, nonce: 'Ygvqdz', payload: '' }).field;
    ...
    describe('utils', function () {
        ...
        describe('parseUri()', function () {
            ...
            it('returns default port when missing', function (done) {
                ...
                var uri = Browser.utils.parseUri('//example.com');
