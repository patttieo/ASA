...
Request('//127.0.0.1:8000/resource/1?b=1&a=2', function (error, response, body) {
...
credentialsFunc('dh37fgj492je', function (err, credentials) {
    ...
    var header = Hawk.client.header('//127.0.0.1:8000/resource/1?b=1&a=2', 'GET', { credentials: credentials, ext: 'and welcome!' });
    var options = {
        uri: '//127.0.0.1:8000/resource/1?b=1&a=2',
        method: 'GET',
        headers: {
