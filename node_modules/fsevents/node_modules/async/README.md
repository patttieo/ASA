...
[![NPM version](//img.shields.io/npm/v/async.svg)](https://www.npmjs.org/package/async)
...
use with [Node.js](//nodejs.org) and installable via `npm install async`,
it can also be used directly in the browser.

Async is also installable via:

- [bower](//bower.io/): `bower install async`
- [component](https://github.com/component/component): `component install
  caolan/async`
- [jam](//jamjs.org/): `jam install async`
- [spm](//spmjs.io/): `spm install async`
...
## Common Pitfalls <sub>[(StackOverflow)](//stackoverflow.com/questions/tagged/async.js)</sub>
...
If JavaScript's event loop is still a bit nebulous, check out [this article](//blog.carbonfive.com/2013/10/27/the-javascript-event-loop-explained/) or [this talk](//2014.jsconf.eu/speakers/philip-roberts-what-the-heck-is-the-event-loop-anyway.html) for more detailed information about how it works.
...
[ECMAScript Language Specification](//www.ecma-international.org/ecma-262/5.1/#sec-8.6)
...
Wrap an async function and ensure it calls its callback on a later tick of the event loop.  If the function already calls its callback on a next tick, no extra deferral is added. This is useful for preventing stack overflows (`RangeError: Maximum call stack size exceeded`) and generally keeping [Zalgo](//blog.izs.me/post/59142742143/designing-apis-for-asynchrony) contained.
