...
## 0.6.12
 ...
 - Added support for [Electron](//electron.atom.io/). Just pass the `--runtime=electron` flag when building/installing. Thanks @zcbenz
...
## 0.5.16
 ...
 - Now supporting all aws-sdk configuration parameters (//docs.aws.amazon.com/AWSJavaScriptSDK/guide/node-configuring.html) (#86)
