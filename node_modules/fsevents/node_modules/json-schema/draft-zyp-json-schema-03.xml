...
<!ENTITY rfc2396 SYSTEM "//xml.resource.org/public/rfc/bibxml/reference.RFC.2396.xml">
...
Content-Type: application/my-media-type+json;
              profile=//json.com/my-hyper-schema
]]>
					</artwork>
				</figure>
				...
				<figure>
					<artwork>
<![CDATA[
Link: <//json.com/my-hyper-schema>; rel="describedby"
]]>
					</artwork>
				</figure>
			...
			<section title="Self-Descriptive Schema">
				<t>
					...
					<eref target="//json-schema.org/draft-03/schema">//json-schema.org/draft-03/schema</eref> for the draft-03 version. The hyper schema 
					self-description can be found at <eref target="//json-schema.org/hyper-schema">//json-schema.org/hyper-schema</eref> 
					or <eref target="//json-schema.org/draft-03/hyper-schema">//json-schema.org/draft-03/hyper-schema</eref>. All schemas
...
Content-Type: application/json; 
              profile=//json-schema.org/draft-03/hyper-schema
]]>
						</artwork>
					</figure>
				</t>
...
<![CDATA[
{
	...
	"extends": {"$ref": "//json-schema.org/draft-03/schema"}
}
]]>
						</artwork>
					</figure>
			...
			<section title="links" anchor="links">
				...
				<section title="Link Description Object">
					<t>
						...
						<eref target="//json-schema.org/draft-03/links">//json-schema.org/draft-03/links</eref> (draft-03 version).
					</t>
	...
	"name": "This representation\
		...
		<section title="IANA Considerations">
			...
			<t>
				...
				meta-schema). Normally the value would be //json-schema.org/draft-03/hyper-schema,
