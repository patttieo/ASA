...
#### The buffer module from [node.js](//nodejs.org/), for the browser.
...
[node's Buffer API](//iojs.org/api/buffer.html). Read the
[official docs](//iojs.org/api/buffer.html) for the full list of properties,
...
[Read more.](//iojs.org/api/buffer.html#buffer_buf_slice_start_end)
...
[node stability index](//nodejs.org/docs/latest/api/documentation.html#documentation_stability_index),
