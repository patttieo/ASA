...
[![build status](https://secure.travis-ci.org/substack/deps-sort.png)](//travis-ci.org/substack/deps-sort)
...
or using `browserify --deps` on a [voxeljs](//voxeljs.com/) project:
