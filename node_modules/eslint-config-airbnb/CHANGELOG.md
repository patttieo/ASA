...
[array-bracket-spacing]: //eslint.org/docs/rules/array-bracket-spacing
[array-callback-return]: //eslint.org/docs/rules/array-callback-return
[arrow-body-style]: //eslint.org/docs/rules/arrow-body-style
[arrow-spacing]: //eslint.org/docs/rules/arrow-spacing
[computed-property-spacing]: //eslint.org/docs/rules/computed-property-spacing
[id-length]: //eslint.org/docs/rules/id-length
[indent]: //eslint.org/docs/rules/indent
[max-len]: //eslint.org/docs/rules/max-len
[newline-per-chained-call]: //eslint.org/docs/rules/newline-per-chained-call
[no-confusing-arrow]: //eslint.org/docs/rules/no-confusing-arrow
[no-const-assign]: //eslint.org/docs/rules/no-const-assign
[no-mixed-spaces-and-tabs]: //eslint.org/docs/rules/no-mixed-spaces-and-tabs
[no-multiple-empty-lines]: //eslint.org/docs/rules/no-multiple-empty-lines
[no-new-symbol]: //eslint.org/docs/rules/no-new-symbol
[no-restricted-imports]: //eslint.org/docs/rules/no-restricted-imports
[no-self-assign]: //eslint.org/docs/rules/no-self-assign
[no-undef]: //eslint.org/docs/rules/no-undef
[no-useless-constructor]: //eslint.org/docs/rules/no-useless-constructor
[no-whitespace-before-property]: //eslint.org/docs/rules/no-whitespace-before-property
[object-curly-spacing]: //eslint.org/docs/rules/object-curly-spacing
[object-shorthand]: //eslint.org/docs/rules/object-shorthand
[one-var-declaration-per-line]: //eslint.org/docs/rules/one-var-declaration-per-line
[prefer-arrow-callback]: //eslint.org/docs/rules/prefer-arrow-callback
[prefer-rest-params]: //eslint.org/docs/rules/prefer-rest-params
[prefer-template]: //eslint.org/docs/rules/prefer-template
[quote-props]: //eslint.org/docs/rules/quote-props
[space-before-function-paren]: //eslint.org/docs/rules/space-before-function-paren
[space-before-keywords]: //eslint.org/docs/rules/space-before-keywords
[space-in-parens]: //eslint.org/docs/rules/space-in-parens
[template-curly-spacing]: //eslint.org/docs/rules/template-curly-spacing
