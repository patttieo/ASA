...
(function ($, window, document, undefined) {
  ...
  window.Foundation = {
    ...
    utils : {
      ...
      //    Modified version of _.debounce() //underscorejs.org
      //
      // Arguments:
  ...
  Foundation.libs.abide = {
    ...
    settings : {
      ...
      patterns : {
        ...
        // //blogs.lse.ac.uk/lti/2008/04/23/a-regular-expression-to-match-any-url/
    ...
    toggle_active_tab : function (tab, location_hash) {
      var self = this,
          ...
          interpret_keyup_action = function (e) {
            // Light modification of Heydon Pickering's Practical ARIA Examples: //heydonworks.com/practical_aria_examples/js/a11y.js
