...
1. If necessary, [install Jekyll](//jekyllrb.com/docs/installation) and other Ruby dependencies with `bundle install`.
   **Note for Windows users:** Read [this unofficial guide](//jekyll-windows.juthilo.com/) to get Jekyll up and running without problems.
...
Editor preferences are available in the [editor config](https://github.com/twbs/bootstrap/blob/master/.editorconfig) for easy use in common text editors. Read more and download plugins at <//editorconfig.org>.
...
See [the Releases section of our GitHub project](https://github.com/twbs/bootstrap/releases) for changelogs for each release version of Bootstrap. Release announcement posts on [the official Bootstrap blog](//blog.getbootstrap.com) contain summaries of the most noteworthy changes made in each release.
